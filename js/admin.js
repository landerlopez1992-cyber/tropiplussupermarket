...
function renderTvList() {
    ...
    container.innerHTML = tvConfigs.map(tv => {
        const tvUrl = `${baseUrl}tv.html?tv=${encodeURIComponent(tv.id)}&v=20260210t`;
        return `
        <div class="tv-list-item">
            ...
            <div class="tv-actions">
                <a class="tv-btn-open" href="tv.html?tv=${encodeURIComponent(tv.id)}&v=20260210t" target="_blank" rel="noopener noreferrer">Abrir Pantalla TV</a>
